    ...
    <div className="flex flex-col flex-grow pt-5 overflow-y-auto bg-white">
      ...
      <div className="flex flex-col flex-1 px-3 mt-6">
        <div className="space-y-4">
          ...
          to="/hero"
              title=""
              className="flex items-center px-4 py-2.5 text-sm font-medium text-white transition-all duration-200 bg-pink-600 rounded-lg group"
            >
              <svg
            ...
            <Link
          to="/tickets"
              className="flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200 text-gray-900 hover:text-white rounded-lg hover:bg-pink-600 group"
            >
              <svg
