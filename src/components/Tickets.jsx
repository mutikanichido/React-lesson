        ...
        <div className="overflow-hidden bg-white shadow-md rounded-xl">
          <div className="p-9">
            ...
            <p className="mt-6 text-base text-gray-600 font-pj">
              ...
              nullam consectetur placerat pellentesque ut massa volutpat at.
              Diam pretium orci dui sagittis.
            </p>
          </div>
        </div>
        <div className="overflow-hidden bg-white shadow-md rounded-xl">
          <div className="p-9">
            ...
            <p className="mt-6 text-base text-gray-600 font-pj">
              ...
              volutpat at. Diam pretium orci dui sagittis. Norem ipsum dolor sit
